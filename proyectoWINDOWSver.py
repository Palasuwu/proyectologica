...
def generate_afn_with_regex(expr):
    ...
    safe_expr = re.sub(r'[^0-9A-Za-z_]+', '_', expr)
    safe_expr = safe_expr.strip('_')
    filename = f"afn_regex_{safe_expr}"

    # LA LÍNEA DEBAJO DE ESTA SOLO FUNCIONA PARA MAC
